...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，this is harper!, Hi，欢迎来到我的博客🎉🎉🎉',
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-1291242539116402', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
